{{-- resources/views/jastiper/kategori-barang/edit.blade.php --}}
...
<div class="form-panel">
    ...
    <form action="{{ route('jastiper.kategori-barang.update', $kategori) }}" method="POST" autocomplete="off">
        @csrf
        @method('PUT')
        ...
        <div class="form-actions">
            <a href="{{ route('jastiper.kategori-barang.index') }}" class="btn btn-secondary">Batal</a>
