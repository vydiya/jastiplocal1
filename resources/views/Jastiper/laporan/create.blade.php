...
<div class="form-panel">
    <h2 class="form-title">Tambah Laporan Penjualan</h2>
    ...
    <form action="{{ route('jastiper.laporan.store') }}" method="POST" autocomplete="off">
        @csrf
        ...
        <div class="form-row">
            <div class="col form-group">
                ...
                <input type="number" step="0.01" name="harga_barang" class="form-control" value="{{ old('harga_barang',0) }}" required>
            </div>

            <div class="col form-group">
                <label class="form-label">Dana Masuk (Rp) <span class="text-danger">*</span></label>
                <input type="number" step="0.01" name="dana_masuk" class="form-control" value="{{ old('dana_masuk',0) }}" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <select name="status" class="form-control">
                ...
                <option value="dana_masuk" {{ old('status') == 'dana_masuk' ? 'selected' : '' }}>dana_masuk</option>
            </select>
        </div>

        <div class="form-group">
            <label class="form-label">Tanggal Masuk (opsional)</label>
            <input type="datetime-local" name="tanggal_masuk" value="{{ old('tanggal_masuk') }}" class="form-control">
