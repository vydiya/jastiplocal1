...
<style>
    ...
    .btn-action { padding: 4px; border-radius: 4px; background: none; border: 1px solid #ccc; transition: all 0.2s; }
    .btn-action:hover { opacity: 0.8; }
    .btn-action img { width: 18px; height: 18px; display: block; }
</style>
@endpush
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex align-items-center">
            ...
            <form method="GET" action="{{ route('admin.kategori.index') }}" class="d-flex me-3">
                <input name="q" value="{{ request('q', $q ?? '') }}" class="form-control user-search-input me-2" type="text"
                    placeholder="Cari ID / Nama kategori" style="width:320px;">
        ...
        {{-- Tombol Tambah --}}
        <a href="{{ route('admin.kategori.create') }}" class="btn btn-primary btn-add-user">
                ...
                <tr data-id="{{ $k->id }}">
                    ...
                    <td class="col-actions">
                        <div class="table-actions">
                            {{-- Edit --}}
                            <a href="{{ route('admin.kategori.edit', $k) }}" class="btn-action edit border-0 bg-transparent p-0" title="Edit">
                            ...
                            <form action="{{ route('admin.kategori.destroy', $k) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn-action del border-0 bg-transparent p-0" title="Hapus" 
