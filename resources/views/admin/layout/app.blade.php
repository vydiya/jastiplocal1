...
<head>
    ...
    <style>
        {{-- Styles spesifik (dari index.html) --}}
    ...
    @yield('head') {{-- tambahan head jika perlu --}}
</head>
<body>
    {{-- Left Panel (sidebar) --}}
    ...
    {{-- Init JS dari index.html (pindahkan atau buat file terpisah di public/admin/assets/js/init-dashboard.js) --}}
    @stack('scripts')
