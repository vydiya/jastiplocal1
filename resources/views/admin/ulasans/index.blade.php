...
<div class="user-table-card">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <form action="{{ route('admin.ulasans.index') }}" method="GET" style="display:flex; gap:8px; align-items:center;">
    ...
    <div class="table-responsive">
        <table class="table table-custom">
            <thead><tr>
                <th>ID</th><th>User</th><th>Jastiper</th><th>Pesanan</th><th>Rating</th><th>Komentar</th><th>Tanggal</th><th class="col-actions">Operasi</th>
            </tr></thead>
            <tbody>
            ...
            <tr>
                ...
                <td class="col-actions">
                    <div class="table-actions">
                        <a href="{{ route('admin.ulasans.show', $u) }}" class="btn-action edit"><img src="{{ asset('admin/assets/images/icons/edit.svg') }}" alt="Lihat"></a>
                        <form action="{{ route('admin.ulasans.destroy', $u) }}" method="POST" style="display:inline;">
                            @csrf @method('DELETE')
                            <button onclick="return confirm('Hapus ulasan ini?')" class="btn-action del"><img src="{{ asset('admin/assets/images/icons/delete.svg') }}" alt="Hapus"></button>
                        </form>
                    </div>
                </td>
            </tr>
