    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                        ...
                        <li class="{{ request()->is('admin/pembayaran*') ? 'active' : '' }}">
                            <a href="{{ route('admin.pembayaran.index') }}">
                                <img src="{{ asset('admin/assets/images/icons/pembayaran.svg') }}"
                                    style="width:20px;margin-right:12px" alt="Pembayaran">
                                Pembayaran
                            </a>
                        </li>

                        <li class="{{ request()->is('admin/kelola-dana*') ? 'active' : '' }}">
                            <a href="{{ route('admin.kelola-dana.index') }}">
                        ...
                        <li class="{{ request()->is('admin/validasi-produk*') ? 'active' : '' }}">
                            <a href="{{ route('admin.validasi-produk.index') }}" aria-label="Validasi Produk">
